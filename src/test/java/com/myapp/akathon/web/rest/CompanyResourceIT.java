...
import com.myapp.akathon.domain.Company;
import com.myapp.akathon.repository.CompanyRepository;
...
class CompanyResourceIT {
    ...
    public static Company createEntity(EntityManager em) {
        Company company = new Company().name(DEFAULT_NAME).dateCreated(DEFAULT_DATE_CREATED);
        return company;
    }
    ...
    public static Company createUpdatedEntity(EntityManager em) {
        Company company = new Company().name(UPDATED_NAME).dateCreated(UPDATED_DATE_CREATED);
        return company;
    }
    ...
    void putExistingCompany() throws Exception {
        ...
        updatedCompany.name(UPDATED_NAME).dateCreated(UPDATED_DATE_CREATED);
    ...
    void partialUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.dateCreated(UPDATED_DATE_CREATED);
    ...
    void fullUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.name(UPDATED_NAME).dateCreated(UPDATED_DATE_CREATED);
