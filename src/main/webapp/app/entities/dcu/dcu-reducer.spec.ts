...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './dcu.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DCU_LIST actions', async () => {
    ...
    it('dispatches FETCH_DCU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DCU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DCU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DCU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DCU actions', async () => {
      const expectedActions = [
        {
