...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './record.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RECORD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RECORD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RECORD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RECORD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RECORD actions', async () => {
      const expectedActions = [
        {
