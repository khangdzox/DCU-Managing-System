...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './factory.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FACTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_FACTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FACTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FACTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FACTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FACTORY actions', async () => {
      const expectedActions = [
        {
