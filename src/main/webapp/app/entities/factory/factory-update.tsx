...
export const FactoryUpdate = () => {
  ...
  const saveEntity = values => {
    ...
    const entity = {
      ...factoryEntity,
      ...values,
      companyName: companies.find(it => it.id.toString() === values.companyName.toString()),
    };
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...
          companyName: factoryEntity?.companyName?.id,
        };
      ...
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="akathonApp.factory.home.createOrEditLabel" data-cy="FactoryCreateUpdateHeading">
            <Translate contentKey="akathonApp.factory.home.createOrEditLabel">Create or edit a Factory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="factory-id"
                  label={translate('akathonApp.factory.id')}
              ...
              <Button tag={Link} id="cancel-save" data-cy="entityCreateCancelButton" to="/factory" replace color="info">
